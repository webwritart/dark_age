...
from operations.messenger import send_email_support, send_email_promotion
                    ...
                    if email == result.email:
                        ...
                        send_email_support(subject="Password reset",
                                           ...
                                           html=render_template('mails/password_reset_link.html',
                                                                link=f"https://promotion.writart.com/account/set_new_password?token={str(token)}&email={email_list[0]}"),
                                           image_dict='')
